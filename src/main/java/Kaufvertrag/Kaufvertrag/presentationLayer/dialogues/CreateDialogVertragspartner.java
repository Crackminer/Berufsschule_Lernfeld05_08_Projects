...
public class CreateDialogVertragspartner
{
  ...
  public CreateDialogVertragspartner(DataBasePanel dataBasePanel, String persistence)
  {
    ...
    confirmButton.addActionListener((ActionEvent evt) ->
      {
        ...
        dataBase.doCreate(returnVertragspartner);
        frame.dispose();
      }
    );
    checkAvailability();
