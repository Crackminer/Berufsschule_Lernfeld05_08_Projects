...
public class UpdateDialogWare
{
  ...
  public UpdateDialogWare(Object[] objectArray, DataBasePanel dataBasePanel)
  {
  ...
  private void initComponents(Object[] objectArray)
  {
    ...
    bezeichnungTextField.setText((String)objectArray[1]);
    beschreibungTextField.setText((String)objectArray[2]);
    preisTextField.setText(String.valueOf((Double)objectArray[3]));
    besonderheitenTextField.setText((String)objectArray[3]);
    maengelTextField.setText((String)objectArray[5]);
