...
public class UpdateDialogKaufvertrag
{
  ...
  public UpdateDialogKaufvertrag(Object[] objectArray, DataBasePanel dataBasePanel, String persistence)
  {
  ...
  private void initComponents(Object[] objectArray)
  {
    ...
    kauferTextField.setText((String)objectArray[1]);
    verkauferTextField.setText((String)objectArray[2]);
    wareTextField.setText((String)objectArray[3]);
    zahlmethodeTextField.setText((String)objectArray[4]);
    ...
    confirmButton.addActionListener((ActionEvent evt) ->
      {
        ...
        dataBase.doUpdate(returnKaufvertrag);
        frame.dispose();
      }
    );
    checkAvailability();
